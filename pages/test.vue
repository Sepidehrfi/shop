<template>
  <base-button @click="isOpenModal = true">ثبت نام کاربر</base-button>

  <base-modal v-model="isOpenModal">سلام</base-modal>
  <base-show-more>
  ...
  <Form :validation-schema="formSchema">
    <base-input name="email" modelValue="" label="ایمیل"></base-input>
  </Form>
</template>
